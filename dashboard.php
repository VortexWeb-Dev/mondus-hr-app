...
<div class="max-w-7xl mx-auto bg-white p-8 rounded-lg shadow-lg space-y-8">
    ...
    <!-- Quick Links Section -->
    <div class="flex justify-between space-x-4 mb-6 flex-wrap">
        <a href="noc_cert.php" class="p-4 bg-blue-500 text-white rounded-md shadow-md hover:bg-blue-600">NOC</a>
        <a href="salary_certificates.php" class="p-4 bg-green-500 text-white rounded-md shadow-md hover:bg-green-600">Salary Certificate</a>
        <a href="employee_details.php" class="p-4 bg-yellow-500 text-white rounded-md shadow-md hover:bg-yellow-600">Employee Details</a>
        <a href="attendance_reports.php" class="p-4 bg-indigo-500 text-white rounded-md shadow-md hover:bg-indigo-600">Attendance Report</a>
        <a href="leave_application.php" class="p-4 bg-red-500 text-white rounded-md shadow-md hover:bg-red-600">Leave Application</a>
    </div>
    ...
    <div class="mt-8 text-center text-gray-500 text-sm">
        <p>HR Dashboard &copy; 2025 - All rights reserved</p>
    </div>
</div>
